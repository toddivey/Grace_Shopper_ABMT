...
async function seed() {
  ...
  const users = await Promise.all([
    ...
    User.create({
      ...
      password: 'brewingitup'
    }),
    User.create({
      email: 'sylvia@email.com',
      firstName: 'Sylvia',
      lastName: 'Plath',
      address: '902 First street',
      password: 'belljarring'
    }),
    User.create({
      email: 'bailey@email.com',
      firstName: 'Bailey',
      lastName: 'Warren',
      address: '5346 Sheridan Place',
      password: 'neverstoprunning'
    }),
    User.create({
      email: 'ray@email.com',
      firstName: 'Ray',
      lastName: 'Bradbury',
      address: '450 Learning Place',
      password: 'here2learn'
    }),
    User.create({
      ...
      firstName: 'Winston',
      lastName: 'Churchill',
      address: '279 Kool Kids drive',
      password: 'laterLozers'
    }),
    User.create({
      email: 'plato@email.com',
      firstName: 'Plato',
      lastName: 'Philosopher',
      address: '6879 Herring Avenue',
      password: 'notinacave'
    })
  ])
  const products = await Promise.all([
    Product.create({
      name: 'Freedom of Speach',
      price: 10,
      status: 'In Stock',
      description:
      ...
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/FreedomofSpeach-Website_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 50,
      ABV: 4,
      brewery: 'Revolution',
      categoryId: 8
    ...
    Product.create({
      ...
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/FinalFreedomofSpeach-Website_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 50,
      ABV: 4,
      brewery: 'Revolution',
      categoryId: 8
    ...
    Product.create({
      ...
      status: 'In Stock',
      description:
        'A highly drinkable Golden Ale steeped with hibiscus, resulting in a natural tartness and slight pink hue.',
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/Rosa-WebCan_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 100,
      ABV: 6,
      brewery: 'Revolution',
      categoryId: 6
    ...
    Product.create({
      ...
      status: 'In Stock',
      description:
        'A crushable ale to celebrate the end of winter and rejoice the coming of warm weather!',
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/SunCrusher-WebCan_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 100,
      ABV: 5,
      brewery: 'Revolution',
      categoryId: 5
    ...
    Product.create({
      ...
      status: 'In Stock',
      description:
        'Our flagship IPA is supremely aromatic, crisp, and drinkable.',
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/antihero-can-NEW_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 200,
      ABV: 7,
      brewery: 'Revolution',
      categoryId: 4
    ...
    Product.create({
      ...
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/eugene-can-NEW_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 200,
      ABV: 7,
      brewery: 'Revolution',
      categoryId: 3
    ...
    Product.create({
      ...
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/COG-WebCan_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 100,
      ABV: 5,
      brewery: 'Revolution',
      categoryId: 5
    ...
    Product.create({
      ...
      status: 'In Stock',
      description:
        'Our Chicago Pilsner. Brewed traditionally German, with a slightly American approach.',
      imageUrl:
        'https://revbrew.com/imager/d37xww59oglu30_cloudfront_net/beer/RevPils-WebCan_7a380b392d6d6308eb7e6af7dcd28cdd.png',
      inventory: 200,
      ABV: 5,
      brewery: 'Revolution',
      categoryId: 10
  ...
  const orders = await Promise.all([
    Order.create({
      created_at: '2019-01-29 00:00:00.000 +00:00',
      shipping_status: 'delivered',
      tracking_num: '1Z-1234-60657',
      total: '10000',
      userId: 1
    }),
    Order.create({
      created_at: '2019-02-15 00:00:00.000 +00:00',
      shipping_status: 'delivered',
      tracking_num: '1Z-1235-60657',
      total: '15000',
      userId: 2
    }),
    Order.create({
      created_at: '2019-03-20 00:00:00.000 +00:00',
      shipping_status: 'delivered',
      tracking_num: '1Z-1236-60657',
      total: '12000',
      userId: 2
    }),
    Order.create({
      created_at: '2019-04-13 00:00:00.000 +00:00',
      shipping_status: 'shipped',
      tracking_num: '1Z-1237-60657',
      total: '8000',
      userId: 4
    }),
    Order.create({
      created_at: '2019-04-14 00:00:00.000 +00:00',
  ...
  const carts = await Promise.all([
    Cart.create({
      status: 'completed',
      created_at: '2019-01-29 00:00:00.000 +00:00',
      closed_at: '2019-01-29 00:00:00.000 +00:00',
      total: '10000',
      userId: 1
    }),
    Cart.create({
      status: 'completed',
      created_at: '2019-02-15 00:00:00.000 +00:00',
      closed_at: '2019-02-15 00:00:00.000 +00:00',
      total: '15000',
      userId: 3
    }),
    Cart.create({
      status: 'completed',
      created_at: '2019-03-20 00:00:00.000 +00:00',
      closed_at: '2019-03-20 00:00:00.000 +00:00',
      total: '12000',
      userId: 4
    }),
    Cart.create({
      status: 'completed',
      created_at: '2019-04-13 00:00:00.000 +00:00',
      closed_at: '2019-04-13 00:00:00.000 +00:00',
      total: '8000',
      userId: 2
    }),
    Cart.create({
      status: 'completed',
      created_at: '2019-04-14 00:00:00.000 +00:00',
      closed_at: '2019-04-14 00:00:00.000 +00:00',
      total: '9000',
      userId: 5
    }),
    Cart.create({
      status: 'open',
      created_at: '2019-04-16 00:00:00.000 +00:00',
      total: '7000'
    })
  ])
  ...
  const review = await Promise.all([
    Review.create({
      content:
        'Here is a wonderful review about a Bourbon County. It was delicious, I would drink more of it.',
      rating: 9,
      productId: 1,
      userId: 2
    }),
    Review.create({
      content:
        'Bud light tastes terrible, hate it. Would only drink if its free.',
      rating: 2,
      productId: 3,
      userId: 3
    }),
    Review.create({
      content:
        'Great Lakes Dortumunder is tasty. An easy drinkable beer that I would be happy to have more of',
      rating: 8,
      productId: 2,
      userId: 2
    }),
    Review.create({
      content:
        'Pipeworks makes some crazy mash ups and their can design is awesome.',
      rating: 8,
      productId: 6,
      userId: 1
    }),
    Review.create({
      content:
        'Two Heated Ale Loved this beer! Nice fruity accents emboldening the hops.',
      rating: 8,
      productId: 3,
      userId: 5
    }),
    Review.create({
      content:
        'Thickest stout I’ve ever had. Chocolate candy bars, fudge, brownies, and some espresso as it warmed. Perfect ba stout.',
      rating: 10,
      productId: 4,
      userId: 6
    }),
    Review.create({
      content: 'Subtle fruity/juicy mixed with little taste of hops',
      rating: 8,
      productId: 3,
      userId: 7
    }),
    Review.create({
      content: 'Apex Predator is a tasting saison/farmhouse ale from Off Color',
      rating: 7,
      productId: 7,
      userId: 3
    }),
    Review.create({
      content: 'Metropolitan Krankshaft is clear and true to style.',
      rating: 7,
      productId: 4,
      userId: 2
    }),
    Review.create({
      content:
        'Revolotion Anti-Hero is a staple of Chicago beers. Crisp and drinkable',
      rating: 8,
      productId: 1,
      userId: 1
    })
